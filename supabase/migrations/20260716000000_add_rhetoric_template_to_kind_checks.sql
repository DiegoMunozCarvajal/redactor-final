-- Add rhetoric-trace and template-generator to the CHECK constraints
-- that were created before these kinds existed (they replaced meta-template
-- in the two-pass template pipeline).
--
...
DECLARE
  ...
  _allowed text[] := ARRAY[
    ...
    'rhetoric-trace','template-generator'
  ];
  _allowed_str text;
  _tbl text;
  _con_name text;
