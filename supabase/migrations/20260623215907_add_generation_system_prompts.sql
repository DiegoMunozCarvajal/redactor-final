CREATE TABLE generation_system_prompts (
...
ALTER TABLE projects ADD COLUMN generation_system_prompt_id uuid REFERENCES generation_system_prompts(id) ON DELETE SET NULL;

-- Seed v1 with the current DEFAULT_SYSTEM_PROMPT from lib/generate.ts
INSERT INTO generation_system_prompts (name, content, is_default) VALUES (
  'System prompt v1',
  '<rol>
