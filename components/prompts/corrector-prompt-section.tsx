...
interface CorrectorLibraryOption {
  id: string
  name: string
...
interface Props {
  ...
  correctorLibrary?: CorrectorLibraryOption[]
      ...
      <div className="mb-8">
        ...
        <Card className="border-dashed">
          <div className="py-8 text-center px-6">
            ...
            {correctorLibrary && correctorLibrary.length > 0 && onSelectFromLibrary ? (
              <div className="flex items-center justify-center gap-2">
                ...
                >
                  <option value="" disabled>
                    Select a corrector prompt…
                  </option>
                  {correctorLibrary.map((cp) => (
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {onCorrect && (
                <Button size="sm" className="text-xs" onClick={onCorrect} disabled={correcting}>
                  {correcting ? (
