      ...
      <div className="mb-8">
        ...
        <Card className="border-dashed">
          <div className="py-8 text-center px-6">
            ...
            <p className="text-sm text-muted-foreground">Loading critique prompt registry...</p>
          </div>
        </Card>
      </div>
    );
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Select
                ...
                disabled={isDisabled}
              >
                <SelectTrigger className="w-[220px] h-7 text-[10px]" aria-label="Critique prompt revision">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              {onCritique && (
                <Button
                  ...
                  className="text-xs"
                  onClick={onCritique}
                  disabled={critiquing || blocked || isDisabled}
